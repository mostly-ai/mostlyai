...
| `file_name`     | \`str             | None\`                                                                  | The filename of an artifact.  |
...
| `download_url`  | \`str             | None\`                                                                  | URL to download the artifact. |
...
| `payment_url`      | \`AnyUrl          | None\`                    | The URL for purchasing this plan. |
