...
| Name | Type | Description | Default | | --- | --- | --- | --- | | `name` | `str | None` | The name of a dataset. | `None` | | `description` | `str | None` | The description of / instructions for a dataset. | `None` | | `connectors` | `list[DatasetConnector] | None` | | `None` |
...
| Name | Type | Description | Default | | --- | --- | --- | --- | | `connector_id` | `str | None` | The unique identifier of a connector. | `None` | | `locations` | `list[str] | None` | | `None` |
...
| Name | Type | Description | Default | | --- | --- | --- | --- | | `no_of_likes` | `int | None` | Number of likes of this dataset. | `None` |
