...
```shell
# uv pip install
uv pip install --index-strategy unsafe-first-match -U torch==2.13.0+cpu torchvision==0.28.0+cpu torchaudio==2.11.0+cpu 'mostlyai[local]' --extra-index-url https://download.pytorch.org/whl/cpu
```

```shell
# standard pip install
pip install -U torch==2.13.0+cpu torchvision==0.28.0+cpu torchaudio==2.11.0+cpu 'mostlyai[local]' --extra-index-url https://download.pytorch.org/whl/cpu
```
