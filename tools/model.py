    ...
    def validate_constraints(self):
        ...
        for idx, constraint in enumerate(self.constraints):
            if constraint.table_name not in table_map:
                raise ValueError(f"table '{constraint.table_name}' referenced by constraint not found")
            ...
            if isinstance(constraint, FixedCombination):
                self._validate_constraint_fixed_combination(constraint, table_columns, column_usage, idx)
            elif isinstance(constraint, Inequality):
                self._validate_constraint_inequality(constraint, table_columns, column_usage, idx)
