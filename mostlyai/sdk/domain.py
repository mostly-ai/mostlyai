...
#   timestamp: 2025-12-29T14:54:51+00:00
...
class ConstraintConfigParams(CustomBaseModel):
    """
    The config parameters contain any configuration of the constraint.
    The structure of the config object depends on the type of the constraint.
...
class ConstraintType(str, Enum):
    """
    The type of constraint. If type is 'Inequality', then 'lowColumn' and 'highColumn' are required. If type is 'FixedCombination', then 'columns' is required.

    """

    inequality = "Inequality"
    fixed_combination = "FixedCombination"
