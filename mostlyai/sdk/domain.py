...
#   timestamp: 2025-02-19T11:15:23+00:00
    ...
    def validate_rebalancing_config(cls, validation):
        ...
        if config and config.rebalancing:
            ...
            if not rebalancing_col.included:
                raise ValueError(
                    f"Rebalancing column '{rebalancing_column}' in table '{validation.source_table.name}' must have `included=True` in the synthetic table"
                )
