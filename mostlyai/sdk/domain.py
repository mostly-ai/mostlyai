...
#   timestamp: 2026-01-07T13:14:33+00:00
...
class ConstraintType(str, Enum):
    """
    The type of constraint. If type is 'Inequality', then 'table_name', 'lowColumn' and 'highColumn' are required. If type is 'FixedCombination', then 'table_name' and 'columns' are required.
