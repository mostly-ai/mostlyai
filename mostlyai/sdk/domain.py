...
#   timestamp: 2025-07-02T17:12:03+00:00
...
class SyntheticTableConfiguration(CustomBaseModel):
    ...
    no_of_simulations: int | None = Field(
        1,
        alias="noOfSimulations",
        description="The number of simulations to run. Only applicable for subject tables.",
    )
