...
#   timestamp: 2025-09-23T08:04:50+00:00
...
class Artifact(CustomBaseModel):
    ...
    file_name: str | None = Field(None, alias="fileName", description="The filename of an artifact.")
    ...
    download_url: str | None = Field(None, alias="downloadUrl", description="URL to download the artifact.")
