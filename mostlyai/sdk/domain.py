...
#   timestamp: 2025-12-18T11:29:20+00:00
...
class FixedCombination(CustomBaseModel):
    """
    A fixed combination constraint that enforces only seen combinations of values across multiple columns.

    """

    type: Literal["FixedCombination"] = Field("FixedCombination", description="The type of constraint.")
    table_name: str = Field(
        ...,
        alias="tableName",
        description="The name of the table this constraint applies to.",
    )
    columns: list[str] = Field(..., description="The names of the columns involved in this constraint.")
...
class Inequality(CustomBaseModel):
    """
    An inequality constraint that enforces a relationship between two columns.
    The constraint ensures that the value in the low_column is less than or equal to the value in the high_column.

    """

    type: Literal["Inequality"] = Field("Inequality", description="The type of constraint.")
    table_name: str = Field(
        ...,
        alias="tableName",
        description="The name of the table this constraint applies to.",
    )
    low_column: str = Field(
        ...,
        alias="lowColumn",
        description="The name of the column that should have the lower value.",
    )
    high_column: str = Field(
        ...,
        alias="highColumn",
        description="The name of the column that should have the higher value.",
    )
...
class Generator(CustomBaseModel):
    ...
    constraints: list[FixedCombination | Inequality] | None = Field(
        None, description="The constraints to apply during data generation."
    )
    random_state: int | None = Field(
        None,
        alias="randomState",
