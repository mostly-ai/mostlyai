...
class Credits(CustomBaseModel):
    daily: UsageCreditStats | None = Field(
        None,
        description="The current credit balance and limits for the user, broken down by time period.",
    )
    monthly: UsageCreditStats | None = Field(
        None,
        description="The current credit balance and limits for the user, broken down by time period.",
    )
