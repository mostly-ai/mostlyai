...
#   timestamp: 2025-02-12T14:47:01+00:00
...
class AssistantMessage(CustomBaseModel):
    ...
    content: str | None = Field(None, description="The content of a message", max_length=65000, min_length=0)
...
class OrganizationListItem(CustomBaseModel):
    ...
    logo: AnyUrl | None = Field(None, description="The URL of the organization's logo.")
...
class OrganizationConfig(CustomBaseModel):
    ...
    website: AnyUrl | None = Field(None, description="The URL of the organization's website.")
...
class User(CustomBaseModel):
    ...
    avatar: AnyUrl | None = Field(None, description="The URL of the user's avatar")
...
class Metadata(CustomBaseModel):
    ...
    owner_image: AnyUrl | None = Field(None, alias="ownerImage", description="The URL of the account's image.")
    visibility: Visibility | None = None
...
class SyntheticTableConfiguration(CustomBaseModel):
    ...
    tabular_compute: str | None = Field(
        None,
        alias="tabularCompute",
        description="The unique identifier of a compute resource. Not applicable for SDK.",
    )
    language_compute: str | None = Field(
        None,
        alias="languageCompute",
        description="The unique identifier of a compute resource. Not applicable for SDK.",
    )
