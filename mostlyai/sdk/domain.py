...
#   timestamp: 2025-12-02T14:18:40+00:00
...
class IntegrationProvider(CustomBaseModel):
    """
    An OAuth2 integration provider that users can connect to.
    """
...
class Provider(str, Enum):
    """
    The OAuth provider identifier (e.g., google, slack, github, dropbox, strava, stripe)
    """
...
class IntegrationAuthorizationConfig(CustomBaseModel):
    """
    ...
    provider: Provider = Field(
        ...,
        description="The OAuth provider identifier (e.g., google, slack, github, dropbox, strava, stripe)",
        examples=["google"],
    )
...
class IntegrationProvidersConfig(CustomBaseModel):
    ...
    icon: str | None = Field(
        ...
        examples=["https://example.com/google-icon.png"],
    )
